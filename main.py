...
GROQ_API_KEY = os.getenv("GROQ_API_KEY", "gsk_XXXX_BU_YERGA_OZ_KALITINGIZNI_YOZING")
PREMIUM_STARS = 85
PREMIUM_DAYS  = 30
...
def app_kb(uid: int):
    l = get_lang(uid)
    return InlineKeyboardMarkup(inline_keyboard=[[
        InlineKeyboardButton(text=T.get(l,T["uz"])["open_app"], web_app=WebAppInfo(url=WEB_APP_URL))
    ]])
